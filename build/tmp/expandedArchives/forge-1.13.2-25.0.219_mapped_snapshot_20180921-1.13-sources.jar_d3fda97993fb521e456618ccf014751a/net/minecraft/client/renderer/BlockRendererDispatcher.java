   ...
   public boolean renderBlock(IBlockState p_195475_1_, BlockPos p_195475_2_, IWorldReader p_195475_3_, BufferBuilder p_195475_4_, Random p_195475_5_, net.minecraftforge.client.model.data.IModelData modelData) {
      try {
         ...
         if (enumblockrendertype == EnumBlockRenderType.INVISIBLE) {
            ...
            case MODEL:
               return this.blockModelRenderer.renderModel(p_195475_3_, this.getModelForState(p_195475_1_), p_195475_1_, p_195475_2_, p_195475_4_, true, p_195475_5_, p_195475_1_.getPositionRandom(p_195475_2_), modelData);
