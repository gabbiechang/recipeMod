...
public class ChunkRenderTask implements Comparable<ChunkRenderTask> {
   ...
   public ChunkRenderTask(RenderChunk renderChunkIn, ChunkRenderTask.Type typeIn, double distanceSqIn) {
      ...
      modelData = net.minecraftforge.client.model.ModelDataManager.getModelData(net.minecraft.client.Minecraft.getInstance().world, new net.minecraft.util.math.ChunkPos(renderChunkIn.getPosition()));
   }
