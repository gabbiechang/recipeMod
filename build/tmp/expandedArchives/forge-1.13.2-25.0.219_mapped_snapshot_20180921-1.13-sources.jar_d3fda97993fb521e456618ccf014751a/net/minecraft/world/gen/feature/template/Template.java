      ...
      if (this.blocks.isEmpty()) {
         ...
         for(int j = 0; j < list1.size(); ++j) {
            ...
            for(int l = 1; l < this.blocks.size(); ++l) {
               ...
               template$basicpalette1.addMapping((this.blocks.get(l).get(j)).blockState, k); //Forge: j -> l, Fixes vanilla typo causing AIOOB writing template with multiple pellets.
            }
         }
