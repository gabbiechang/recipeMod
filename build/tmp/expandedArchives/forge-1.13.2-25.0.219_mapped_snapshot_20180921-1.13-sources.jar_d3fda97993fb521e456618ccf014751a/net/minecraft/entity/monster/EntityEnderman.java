...
public class EntityEnderman extends EntityMob {
   ...
   static class AIPlaceBlock extends EntityAIBase {
      ...
      public void tick() {
         ...
         if (iblockstate2 != null && this.func_195924_a(iworld, blockpos, iblockstate2, iblockstate, iblockstate1) && !net.minecraftforge.event.ForgeEventFactory.onBlockPlace(enderman, new net.minecraftforge.common.util.BlockSnapshot(enderman.world, blockpos, iblockstate), net.minecraft.util.EnumFacing.UP)) {
