            ...
            if (!this.onGround && !flag1) {
               ...
               if (iblockstate.getBlock() != Blocks.MOVING_PISTON) {
                  ...
                  if (!this.dontSetBlock) {
                     if (iblockstate.getMaterial().isReplaceable() && (flag1 || !BlockFalling.canFallThrough(this.world.getBlockState(blockpos1.down()))) && !net.minecraftforge.event.ForgeEventFactory.onBlockPlace(this, new net.minecraftforge.common.util.BlockSnapshot(getEntityWorld(), getPosition(), iblockstate), net.minecraft.util.EnumFacing.UP) && this.world.setBlockState(blockpos1, this.fallTile, 3)) {
