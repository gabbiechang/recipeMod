...
public abstract class EntityPlayer extends EntityLivingBase {
   ...
   public void writeAdditional(NBTTagCompound compound) {
      ...
      if (spawnDimension != net.minecraft.world.dimension.DimensionType.OVERWORLD) {
         compound.setString("SpawnDimension", spawnDimension.getRegistryName().toString());
      }
   }
   ...
   public BlockPos getBedLocation(net.minecraft.world.dimension.DimensionType dim) {
      return dim == net.minecraft.world.dimension.DimensionType.OVERWORLD ? bedLocation : spawnPosMap.get(dim.getRegistryName());
   }
