...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
   ...
   public void teleport(WorldServer p_200619_1_, double x, double y, double z, float yaw, float pitch) {
      ...
      if (p_200619_1_ == this.world) {
         ...
         this.connection.sendPacket(new SPacketRespawn(this.dimension, p_200619_1_.getDifficulty(), p_200619_1_.getWorldInfo().getTerrainType(), this.interactionManager.getGameType())); // Forge: Use new dimensions information
