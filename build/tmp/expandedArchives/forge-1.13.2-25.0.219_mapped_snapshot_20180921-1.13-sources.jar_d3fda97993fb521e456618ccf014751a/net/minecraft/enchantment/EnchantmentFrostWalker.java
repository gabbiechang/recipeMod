         ...
         for(BlockPos.MutableBlockPos blockpos$mutableblockpos1 : BlockPos.getAllInBoxMutable(pos.add((double)(-f), -1.0D, (double)(-f)), pos.add((double)f, -1.0D, (double)f))) {
            if (blockpos$mutableblockpos1.distanceSqToCenter(living.posX, living.posY, living.posZ) <= (double)(f * f)) {
               ...
               if (iblockstate1.isAir()) {
                  ...
                  if (iblockstate2.getMaterial() == Material.WATER && isFull && iblockstate.isValidPosition(worldIn, blockpos$mutableblockpos1) && worldIn.checkNoEntityCollision(iblockstate, blockpos$mutableblockpos1) && !net.minecraftforge.event.ForgeEventFactory.onBlockPlace(living, new net.minecraftforge.common.util.BlockSnapshot(worldIn, blockpos$mutableblockpos1.toImmutable(), iblockstate2), net.minecraft.util.EnumFacing.UP)) {
