...
public abstract class PlayerList {
   ...
   public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP playerIn, DimensionType dimension, boolean conqueredEnd) {
      ...
      this.players.remove(playerIn);
      this.server.getWorld(playerIn.dimension).removeEntityDangerously(playerIn, true); // Forge: keep data until copyFrom called
      ...
      entityplayermp.connection.sendPacket(new SPacketRespawn(entityplayermp.dimension, world.getDifficulty(), world.getWorldInfo().getTerrainType(), entityplayermp.interactionManager.getGameType())); // Forge: Use new dimensions information 
